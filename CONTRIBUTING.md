# Contributing to im-e-topology

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-e-topology. These guidelines are not strict rules.
...
The im-e-topology team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-e-topology technical leads
...
[issues]: https://github.com/Netbeheer Nederland/im-e-topology/issues/
[pulls]: https://github.com/Netbeheer Nederland/im-e-topology/pulls/
